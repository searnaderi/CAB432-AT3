...
CREATE TABLE `likes` (
  ...
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique_like` (`username`,`video_id`),
  KEY `video_id` (`video_id`),
...
CREATE TABLE `videos` (
  ...
  CONSTRAINT `videos_ibfk_1` FOREIGN KEY (`playlist_id`) REFERENCES `playlists` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2024-10-04 23:06:25
